...
class CHIEF(nn.Module):
    ...
    def forward(self, h, x_anatomic,uni_patch_fea,virchow2_patch_fea,h_optimus_patch_fea):
        batch = x_anatomic
        h_ori = h
        ...
        uni_slide_embeddings = torch.mm(A, uni_patch_fea)
        virchow2_slide_embeddings = torch.mm(A, virchow2_patch_fea)
        h_optimus_slide_embeddings = torch.mm(A, h_optimus_patch_fea)
        ...
        result = {
            ...
            'UNI_WSI_feature': uni_slide_embeddings,
            'virchow2_WSI_feature': virchow2_slide_embeddings,
            'h_optimus_WSI_feature': h_optimus_slide_embeddings,
